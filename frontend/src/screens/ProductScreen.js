...
function ProductScreen() {
  ...
  const addToCartHandler = async () => {
    ...
    if (data.countInStock < quantity) {
      window.alert('Вибачте. Товару більше не має в наявності.');
      return;
    }
    ctxDispatch({
      type: 'CART_ADD_ITEM',
  ...
  return loading ? (
    ...
    <div>
                  ...
                  <Row>
                    ...
                    <Col>
                      {product.countInStock > 0 ? (
                        <Badge bg="success">В продажу</Badge>
                      ) : (
      ...
      <div className="my-3">
        <h2 ref={reviewsRef}>Відгуки</h2>
        <div className="mb-3">
          {product.reviews.length === 0 && (
            <MessageBox>На цьому товарі поки немає відгуків, будьте першим!</MessageBox>
          )}
        </div>
        <ListGroup>
        ...
        <div className="my-3">
          {userInfo ? (
            <form onSubmit={submitHandler}>
                <h2>Написати відгук про товар</h2>
